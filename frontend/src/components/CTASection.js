		...
		<div className="absolute -right-10 -bottom-10 h-40 w-40 rounded-full" style={{ background: 'rgba(255,255,255,0.04)', filter: 'blur(24px)' }} />
			<div className="relative flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
				...
				<form className="mt-3 flex w-full max-w-md gap-2 sm:mt-0">
					<input type="email" placeholder="Enter your email" className="w-full rounded-full px-4 py-3 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white" />
